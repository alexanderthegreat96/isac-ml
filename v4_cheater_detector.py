...
class IsacAntiCheat:
    ...
    def preprocess(self) -> pd.DataFrame:
        ...
        s["hsToBsRatio"] = ratios['hsToBsRatio']
        s["percentageOfHeadshots"] = (s["headshots"] / (s["weaponHits"] + 1)) * 100
...
stats = {
    ...
    "headshots": 	450407,
    "bodyshots": 	1615786,
    "headshotKills": 135123,
    "npcKills": 		112377
}

detector = IsacAntiCheat(
    "models/v5_cheater_nn_model.keras",
    "models/v5_cheater_scaler.pkl",
    "models/v5_feature_medians.json",
    "models/v5_feature_stds.json",
    "models/v5_feature_mads.json",
    **stats
)
